...
function underscores_scripts() {
	...
	wp_enqueue_style( 'underscores-custom-style', get_template_directory_uri() . '/css/custom.css', array(), _S_VERSION );
...
function my_acf_blocks_init() {
	...
	if ( function_exists( 'acf_register_block_type' ) ) {
		...
		acf_register_block_type(
			array(
				'name'              => 'hero',
				'title'             => __( 'Hero', 'underscores' ),
				'description'       => __( 'A custom hero block.', 'underscores' ),
		...
		acf_register_block_type(
			array(
				'name'              => 'testimonials',
				'title'             => __( 'Testimonials', 'underscores' ),
				'description'       => __( 'A custom testimonials block.', 'underscores' ),
